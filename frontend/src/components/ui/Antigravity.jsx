  ...
  useFrame((state) => {
    ...
    particles.forEach((particle, i) => {
      ...
      const projTargetY = targetY * projectionFactor;
        ...
        targetPos.x = projTargetX + currentRingRadius * Math.cos(angle);
        targetPos.y = projTargetY + currentRingRadius * Math.sin(angle);
      ...
      const currentDistToMouse = Math.sqrt(
        Math.pow(particle.cx - projTargetX, 2) + Math.pow(particle.cy - projTargetY, 2)
      );
